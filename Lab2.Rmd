...
poly_results %>% ggplot(aes(x = package_integer, y = price)) + geom_smooth(method = lm, formula = price ~ poly(package_integer, degree = 4), color = "midnightblue", size = 1.2, se = FALSE)
```
